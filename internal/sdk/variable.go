...
func newVariable(rootSDK *VoiceflowSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Variable {
	return &Variable{
		rootSDK:          rootSDK,
...
func (s *Variable) Delete(ctx context.Context, request operations.StableVariableControllerDeleteRequest, opts ...operations.Option) (*operations.StableVariableControllerDeleteResponse, error) {
	...
	res := &operations.StableVariableControllerDeleteResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
