...
func newKnowledgeBase(rootSDK *VoiceflowSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *KnowledgeBase {
...
func (s *KnowledgeBase) Query(ctx context.Context, request operations.StableKnowledgeBaseControllerQueryRequest, opts ...operations.Option) (*operations.StableKnowledgeBaseControllerQueryResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/v1/stable/knowledge-base/query")
	if err != nil {
	...
	res := &operations.StableKnowledgeBaseControllerQueryResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			if o.SkipDeserialization == nil || !*o.SkipDeserialization {
				...
				var out components.StableKnowledgeBaseQueryResponse
				if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
					return nil, err
				}

				res.StableKnowledgeBaseQueryResponse = &out
			}
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
