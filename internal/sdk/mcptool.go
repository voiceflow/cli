...
func newMcpTool(rootSDK *VoiceflowSDK, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *McpTool {
	return &McpTool{
		rootSDK:          rootSDK,
...
func (s *McpTool) List(ctx context.Context, request operations.StableMCPToolControllerListRequest, opts ...operations.Option) (*operations.StableMCPToolControllerListResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/v1/stable/mcp-tool")
	if err != nil {
	...
	res := &operations.StableMCPToolControllerListResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			if o.SkipDeserialization == nil || !*o.SkipDeserialization {
				...
				var out components.StableMCPToolListResponse
				if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
					return nil, err
				}

				res.StableMCPToolListResponse = &out
			}
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
...
func (s *McpTool) Get(ctx context.Context, request operations.StableMCPToolControllerGetRequest, opts ...operations.Option) (*operations.StableMCPToolControllerGetResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
		operations.SupportedOptionSkipDeserialization,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v1/stable/mcp-tool/{toolID}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.StableMCPToolControllerGetResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			if o.SkipDeserialization == nil || !*o.SkipDeserialization {
				...
				var out components.StableMCPToolResponse
				if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
					return nil, err
				}

				res.StableMCPToolResponse = &out
			}
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
