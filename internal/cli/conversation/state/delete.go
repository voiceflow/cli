...
func initDeleteCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		Use:     "delete",
		Short:   "Delete state",
		Long:    "Delete conversation state for a user.",
		Example: "  vf state delete --user-id <id> --project-id <id> --environment-alias <value> --version-param draft",
		RunE:    runDeleteCmd,
	}
	flagutil.RegisterFlags(cmd, deleteCmdMeta)
	if err := flagutil.ValidateMeta[operations.StableConversationStateControllerDeleteRequest](deleteCmdMeta); err != nil {
...
func runDeleteCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.StableConversationStateControllerDeleteRequest](cmd, deleteCmdMeta, "", "")
	if err != nil {
		return err
	}
	...
	res, err := s.Conversation.State.Delete(cmd.Context(), *req, sdkOpts...)
	if err != nil {
