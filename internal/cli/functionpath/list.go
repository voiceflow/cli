...
func initListCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		Use:     "list",
		Short:   "List paths",
		Long:    "List all paths by function ID.",
		Example: "  vf function-path list --project-id <id> --environment-alias <value> --function-id <id>",
		RunE:    runListCmd,
	}
	flagutil.RegisterFlags(cmd, listCmdMeta)
	if err := flagutil.ValidateMeta[operations.StableFunctionPathControllerListRequest](listCmdMeta); err != nil {
...
func runListCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.StableFunctionPathControllerListRequest](cmd, listCmdMeta, "", "")
	if err != nil {
		return err
	}
	...
	res, err := s.FunctionPath.List(cmd.Context(), *req, sdkOpts...)
	if err != nil {
