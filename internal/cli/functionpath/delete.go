...
func initDeleteCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		Use:     "delete",
		Short:   "Delete path",
		Long:    "Delete a path by ID.",
		Example: "  vf function-path delete --path-id <id> --project-id <id> --environment-alias <value>",
		RunE:    runDeleteCmd,
	}
	flagutil.RegisterFlags(cmd, deleteCmdMeta)
	if err := flagutil.ValidateMeta[operations.StableFunctionPathControllerDeleteRequest](deleteCmdMeta); err != nil {
...
func runDeleteCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.StableFunctionPathControllerDeleteRequest](cmd, deleteCmdMeta, "", "")
	if err != nil {
		return err
	}
	...
	res, err := s.FunctionPath.Delete(cmd.Context(), *req, sdkOpts...)
	if err != nil {
