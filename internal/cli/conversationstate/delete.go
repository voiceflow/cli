...
func initDeleteCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Example: "  vf conversation-state delete --user-id <id> --project-id <id> --environment-alias <value> --version-param draft",
		RunE:    runDeleteCmd,
	}
...
func runDeleteCmd(cmd *cobra.Command, args []string) error {
	...
	res, err := s.ConversationState.Delete(cmd.Context(), *req, sdkOpts...)
	if err != nil {
