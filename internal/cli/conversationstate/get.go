...
func initGetCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Example: "  vf conversation-state get --user-id <id> --project-id <id> --environment-alias <value> --version-param draft",
		RunE:    runGetCmd,
	}
...
func runGetCmd(cmd *cobra.Command, args []string) error {
	...
	res, err := s.ConversationState.Get(cmd.Context(), *req, sdkOpts...)
	if err != nil {
