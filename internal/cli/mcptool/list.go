...
var listCmdMeta = []flagutil.FlagMeta{
	...
	{FlagName: "server-id", Shorthand: "s", FieldPath: "ServerID", Kind: flagutil.FlagKindString, Optional: true, Description: "string value"},
}
...
func initListCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Long:    "List all MCP tools by project ID.",
		Example: "  vf mcp-tool list --project-id <id> --environment-alias <value>",
		RunE:    runListCmd,
	}
	flagutil.RegisterFlags(cmd, listCmdMeta)
	if err := flagutil.ValidateMeta[operations.StableMCPToolControllerListRequest](listCmdMeta); err != nil {
...
func runListCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.StableMCPToolControllerListRequest](cmd, listCmdMeta, "", "")
	if err != nil {
		return err
	}
	...
	res, err := s.McpTool.List(cmd.Context(), *req, sdkOpts...)
	if err != nil {
