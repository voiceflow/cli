...
func initGetCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		Use:     "get",
		Short:   "Get MCP tool",
		Long:    "Get an MCP tool by ID.",
		Example: "  vf mcp-tool get --tool-id <id> --project-id <id> --environment-alias <value>",
		RunE:    runGetCmd,
	}
	flagutil.RegisterFlags(cmd, getCmdMeta)
	if err := flagutil.ValidateMeta[operations.StableMCPToolControllerGetRequest](getCmdMeta); err != nil {
...
func runGetCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.StableMCPToolControllerGetRequest](cmd, getCmdMeta, "", "")
	if err != nil {
		return err
	}
	...
	res, err := s.McpTool.Get(cmd.Context(), *req, sdkOpts...)
	if err != nil {
