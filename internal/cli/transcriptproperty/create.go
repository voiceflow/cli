...
var createCmdMeta = []flagutil.FlagMeta{
	...
	{FlagName: "type", Shorthand: "t", FieldPath: "Body.Type", Kind: flagutil.FlagKindEnum, Required: true, EnumValues: []string{"boolean", "number", "string"}, Description: "The type of value the property holds. (options: boolean, number, string) [required]"},
}
...
func initCreateCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		Use:     "create",
		Short:   "Create property",
		Long:    "Create a new property.",
		Example: "  vf transcript-property create --project-id <id> --name <value> --type string",
		RunE:    runCreateCmd,
	}
	flagutil.RegisterFlags(cmd, createCmdMeta)
	if err := flagutil.ValidateMeta[operations.StableTranscriptPropertyControllerCreateRequest](createCmdMeta); err != nil {
...
func runCreateCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.StableTranscriptPropertyControllerCreateRequest](cmd, createCmdMeta, "Body", "body")
	if err != nil {
		return err
	}
	...
	res, err := s.TranscriptProperty.Create(cmd.Context(), *req, sdkOpts...)
	if err != nil {
