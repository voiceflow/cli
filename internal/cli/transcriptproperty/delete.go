...
func initDeleteCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Long:    "Delete a property by ID.",
		Example: "  vf transcript-property delete --property-id <id> --project-id <id>",
		RunE:    runDeleteCmd,
	}
	flagutil.RegisterFlags(cmd, deleteCmdMeta)
	if err := flagutil.ValidateMeta[operations.StableTranscriptPropertyControllerDeleteRequest](deleteCmdMeta); err != nil {
...
func runDeleteCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.StableTranscriptPropertyControllerDeleteRequest](cmd, deleteCmdMeta, "", "")
	if err != nil {
		return err
	}
	...
	res, err := s.TranscriptProperty.Delete(cmd.Context(), *req, sdkOpts...)
	if err != nil {
