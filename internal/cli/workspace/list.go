...
func initListCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Long:    "List all workspaces the authorized account is a member of.",
		Example: "  vf workspace list",
		RunE:    runListCmd,
	}
...
func runListCmd(cmd *cobra.Command, args []string) error {
	...
	res, err := s.Workspace.List(cmd.Context(), sdkOpts...)
	if err != nil {
