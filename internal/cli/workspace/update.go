...
func initUpdateCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Long:    "Update a single workspace by ID.",
		Example: "  vf workspace update --workspace-id <id>",
		RunE:    runUpdateCmd,
	}
	flagutil.RegisterFlags(cmd, updateCmdMeta)
	if err := flagutil.ValidateMeta[operations.StableWorkspaceControllerUpdateRequest](updateCmdMeta); err != nil {
...
func runUpdateCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.StableWorkspaceControllerUpdateRequest](cmd, updateCmdMeta, "Body", "body")
	if err != nil {
		return err
	}
	...
	res, err := s.Workspace.Update(cmd.Context(), *req, sdkOpts...)
	if err != nil {
