...
var updateCmdMeta = []flagutil.FlagMeta{
	...
	{FlagName: "name", Shorthand: "n", FieldPath: "Body.Name", Kind: flagutil.FlagKindString, Optional: true, Description: "The name used to reference the variable in the function code."},
...
func initUpdateCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Example: "  vf function-variable update --variable-id <id> --project-id <id> --environment-alias <value>",
		RunE:    runUpdateCmd,
	}
	flagutil.RegisterFlags(cmd, updateCmdMeta)
	if err := flagutil.ValidateMeta[operations.StableFunctionVariableControllerUpdateRequest](updateCmdMeta); err != nil {
...
func runUpdateCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.StableFunctionVariableControllerUpdateRequest](cmd, updateCmdMeta, "Body", "body")
	if err != nil {
		return err
	}
	...
	res, err := s.Function.Variable.Update(cmd.Context(), *req, sdkOpts...)
	if err != nil {
