...
func initListCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Long:    "List all functions by project ID.",
		Example: "  vf function list --project-id <id> --environment-alias <value>",
		RunE:    runListCmd,
	}
	flagutil.RegisterFlags(cmd, listCmdMeta)
	if err := flagutil.ValidateMeta[operations.StableFunctionControllerListRequest](listCmdMeta); err != nil {
...
func runListCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.StableFunctionControllerListRequest](cmd, listCmdMeta, "", "")
	if err != nil {
		return err
	}
	...
	res, err := s.Function.List(cmd.Context(), *req, sdkOpts...)
	if err != nil {
