...
func initDeleteCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Example: "  vf path delete --path-id <id> --project-id <id> --environment-alias <value>",
		RunE:    runDeleteCmd,
	}
...
func runDeleteCmd(cmd *cobra.Command, args []string) error {
	...
	res, err := s.Function.Path.Delete(cmd.Context(), *req, sdkOpts...)
	if err != nil {
