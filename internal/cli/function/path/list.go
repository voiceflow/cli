...
func initListCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Example: "  vf path list --project-id <id> --environment-alias <value> --function-id <id>",
		RunE:    runListCmd,
	}
...
func runListCmd(cmd *cobra.Command, args []string) error {
	...
	res, err := s.Function.Path.List(cmd.Context(), *req, sdkOpts...)
	if err != nil {
