...
func initListCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		Use:     "list",
		Short:   "List secrets",
		Long:    "List all secrets by project ID. Secret values are never returned.",
		Example: "  vf secret list --project-id <id>",
		RunE:    runListCmd,
	}
	flagutil.RegisterFlags(cmd, listCmdMeta)
	if err := flagutil.ValidateMeta[operations.StableSecretControllerListV2Request](listCmdMeta); err != nil {
...
func runListCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.StableSecretControllerListV2Request](cmd, listCmdMeta, "", "")
	if err != nil {
		return err
	}
	...
	res, err := s.Secret.List(cmd.Context(), *req, sdkOpts...)
	if err != nil {
