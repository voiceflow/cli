...
var listCmdMeta = []flagutil.FlagMeta{
	...
	{FlagName: "include-instructions", Shorthand: "i", FieldPath: "IncludeInstructions", Kind: flagutil.FlagKindBool, Optional: true, HasDefault: true, Description: "boolean flag"},
}
...
func initListCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Long:    "List all playbooks by project ID.",
		Example: "  vf playbook list --project-id <id> --environment-alias <value>",
		RunE:    runListCmd,
	}
	flagutil.RegisterFlags(cmd, listCmdMeta)
	if err := flagutil.ValidateMeta[operations.StablePlaybookControllerListV2Request](listCmdMeta); err != nil {
...
func runListCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.StablePlaybookControllerListV2Request](cmd, listCmdMeta, "", "")
	if err != nil {
		return err
	}
	...
	res, err := s.Playbook.List(cmd.Context(), *req, sdkOpts...)
	if err != nil {
