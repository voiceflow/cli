...
func initGetCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		Use:     "get",
		Short:   "Get API tool",
		Long:    "Get an API tool by ID.",
		Example: "  vf api-tool get --tool-id <id> --project-id <id> --environment-alias <value>",
		RunE:    runGetCmd,
	}
	flagutil.RegisterFlags(cmd, getCmdMeta)
	if err := flagutil.ValidateMeta[operations.StableAPIToolControllerGetV2Request](getCmdMeta); err != nil {
...
func runGetCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.StableAPIToolControllerGetV2Request](cmd, getCmdMeta, "", "")
	if err != nil {
		return err
	}
	...
	res, err := s.APITool.Get(cmd.Context(), *req, sdkOpts...)
	if err != nil {
