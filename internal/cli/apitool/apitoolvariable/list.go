...
var listCmdMeta = []flagutil.FlagMeta{
	...
	{FlagName: "api-tool-id", Shorthand: "a", FieldPath: "APIToolID", Kind: flagutil.FlagKindString, Required: true, Description: "[required]"},
}
...
func initListCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Long:    "List all variables by API tool ID.",
		Example: "  vf api-tool-variable list --project-id <id> --environment-alias <value> --api-tool-id <id>",
		RunE:    runListCmd,
	}
...
func runListCmd(cmd *cobra.Command, args []string) error {
	...
	res, err := s.APITool.Variable.List(cmd.Context(), *req, sdkOpts...)
	if err != nil {
