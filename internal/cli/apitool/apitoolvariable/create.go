...
func initCreateCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Example: "  vf api-tool-variable create --project-id <id> --environment-alias <value> --name <value> --api-tool-id <id>",
		RunE:    runCreateCmd,
	}
...
func runCreateCmd(cmd *cobra.Command, args []string) error {
	...
	res, err := s.APITool.Variable.Create(cmd.Context(), *req, sdkOpts...)
	if err != nil {
