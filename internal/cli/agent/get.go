...
func initGetCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Example: "  vf agent get --project-id <id> --environment-alias <value>",
		RunE:    runGetCmd,
	}
	flagutil.RegisterFlags(cmd, getCmdMeta)
	if err := flagutil.ValidateMeta[operations.StableAgentControllerGetV2Request](getCmdMeta); err != nil {
...
func runGetCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.StableAgentControllerGetV2Request](cmd, getCmdMeta, "", "")
	if err != nil {
		return err
	}
