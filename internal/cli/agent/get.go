...
func initGetCmd(parent *cobra.Command) error {
	...
	if err := flagutil.ValidateMeta[operations.StableAgentControllerGetRequest](getCmdMeta); err != nil {
...
func runGetCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.StableAgentControllerGetRequest](cmd, getCmdMeta, "", "")
	if err != nil {
		return err
	}
