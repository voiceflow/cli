...
func initListCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Long:    "List all MCP servers by project ID.",
		Example: "  vf mcp-server list --project-id <id> --environment-alias <value>",
		RunE:    runListCmd,
	}
	flagutil.RegisterFlags(cmd, listCmdMeta)
	if err := flagutil.ValidateMeta[operations.StableMCPServerControllerListV2Request](listCmdMeta); err != nil {
...
func runListCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.StableMCPServerControllerListV2Request](cmd, listCmdMeta, "", "")
	if err != nil {
		return err
	}
	...
	res, err := s.McpServer.List(cmd.Context(), *req, sdkOpts...)
	if err != nil {
