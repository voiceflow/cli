...
func initGetCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		Use:     "get",
		Short:   "Get MCP server",
		Long:    "Get an MCP server by ID.",
		Example: "  vf mcp-server get --server-id <id> --project-id <id> --environment-alias <value>",
		RunE:    runGetCmd,
	}
	flagutil.RegisterFlags(cmd, getCmdMeta)
	if err := flagutil.ValidateMeta[operations.StableMCPServerControllerGetV2Request](getCmdMeta); err != nil {
...
func runGetCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.StableMCPServerControllerGetV2Request](cmd, getCmdMeta, "", "")
	if err != nil {
		return err
	}
	...
	res, err := s.McpServer.Get(cmd.Context(), *req, sdkOpts...)
	if err != nil {
