...
func initUpdateCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Long:    "Update a environment by alias or ID.",
		Example: "  vf environment update --environment-alias <value> --project-id <id>",
		RunE:    runUpdateCmd,
	}
	flagutil.RegisterFlags(cmd, updateCmdMeta)
	if err := flagutil.ValidateMeta[operations.StableEnvironmentControllerUpdateRequest](updateCmdMeta); err != nil {
...
func runUpdateCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.StableEnvironmentControllerUpdateRequest](cmd, updateCmdMeta, "Body", "body")
	if err != nil {
		return err
	}
	...
	res, err := s.Environment.Update(cmd.Context(), *req, sdkOpts...)
	if err != nil {
