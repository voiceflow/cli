...
func initGetCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Long:    "Get an environment by alias or ID.",
		Example: "  vf environment get --environment-alias <value> --project-id <id>",
		RunE:    runGetCmd,
	}
	flagutil.RegisterFlags(cmd, getCmdMeta)
	if err := flagutil.ValidateMeta[operations.StableEnvironmentControllerGetRequest](getCmdMeta); err != nil {
...
func runGetCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.StableEnvironmentControllerGetRequest](cmd, getCmdMeta, "", "")
	if err != nil {
		return err
	}
	...
	res, err := s.Environment.Get(cmd.Context(), *req, sdkOpts...)
	if err != nil {
