...
func initGetCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Example: "  vf variable get --variable-id <id> --project-id <id> --environment-alias <value>",
		RunE:    runGetCmd,
	}
	flagutil.RegisterFlags(cmd, getCmdMeta)
	if err := flagutil.ValidateMeta[operations.StableVariableControllerGetV2Request](getCmdMeta); err != nil {
...
func runGetCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.StableVariableControllerGetV2Request](cmd, getCmdMeta, "", "")
	if err != nil {
		return err
	}
	...
	res, err := s.Variable.Get(cmd.Context(), *req, sdkOpts...)
	if err != nil {
