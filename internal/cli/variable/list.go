...
func initListCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		...
		Long:    "List all variables by project ID.",
		Example: "  vf variable list --project-id <id> --environment-alias <value>",
		RunE:    runListCmd,
	}
	flagutil.RegisterFlags(cmd, listCmdMeta)
	if err := flagutil.ValidateMeta[operations.StableVariableControllerListV2Request](listCmdMeta); err != nil {
...
func runListCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.StableVariableControllerListV2Request](cmd, listCmdMeta, "", "")
	if err != nil {
		return err
	}
	...
	res, err := s.Variable.List(cmd.Context(), *req, sdkOpts...)
	if err != nil {
