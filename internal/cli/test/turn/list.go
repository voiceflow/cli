...
var listCmdMeta = []flagutil.FlagMeta{
	...
	{FlagName: "test-id", Shorthand: "t", FieldPath: "TestID", Kind: flagutil.FlagKindString, Required: true, Description: "[required]"},
}
...
func initListCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		Use:     "list",
		Short:   "List turns",
		Long:    "List all turns by test ID.",
		Example: "  vf turn list --project-id <id> --environment-alias <value> --test-id <id>",
		RunE:    runListCmd,
	}
	flagutil.RegisterFlags(cmd, listCmdMeta)
	if err := flagutil.ValidateMeta[operations.StableTestTurnControllerListRequest](listCmdMeta); err != nil {
...
func runListCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.StableTestTurnControllerListRequest](cmd, listCmdMeta, "", "")
	if err != nil {
		return err
	}
	...
	res, err := s.Test.Turn.List(cmd.Context(), *req, sdkOpts...)
	if err != nil {
