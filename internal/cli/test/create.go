...
func initCreateCmd(parent *cobra.Command) error {
	var cmd = &cobra.Command{
		Use:     "create",
		Short:   "Create test",
		Long:    "Create a new test.",
		Example: "  vf test create --project-id <id> --environment-alias <value> --name <value>",
		RunE:    runCreateCmd,
	}
	flagutil.RegisterFlags(cmd, createCmdMeta)
	if err := flagutil.ValidateMeta[operations.StableTestControllerCreateRequest](createCmdMeta); err != nil {
...
func runCreateCmd(cmd *cobra.Command, args []string) error {
	...
	req, err := flagutil.BuildRequest[operations.StableTestControllerCreateRequest](cmd, createCmdMeta, "Body", "body")
	if err != nil {
		return err
	}
	...
	res, err := s.Test.Create(cmd.Context(), *req, sdkOpts...)
	if err != nil {
