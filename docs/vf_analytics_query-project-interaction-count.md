...
```
  vf analytics query-project-interaction-count --project-id <id> --end-date <value> --start-date <value> --interval week
```
...
```
  ...
  -h, --help                       help for query-project-interaction-count
