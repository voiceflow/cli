...
```
  vf analytics query-hourly-organization-token-usage --organization-id <id> --end-date <value> --start-date <value>
```
...
```
  ...
  -h, --help                        help for query-hourly-organization-token-usage
