...
```
  vf analytics query-hourly-project-token-usage --project-id <id> --end-date <value> --start-date <value> --interval hour
```
...
```
  ...
  -h, --help                       help for query-hourly-project-token-usage
